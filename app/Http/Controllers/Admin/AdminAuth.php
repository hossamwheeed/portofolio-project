...

{
    ...
    public function dologin(){
      ...
      //  $rememberme=request('rememberme')==1? true:false;
       // dd(admin());
       // dd(admin()->attempt());
        //dd(admin()->attempt(['email'=>request('email'),'password'=>request('password')]));
    ...
    public function forgot_password_post(){
     ...
     if(!empty($admin)){
            ...
            session()->flash('sucess',trans('admin.the_link_reset_sent'));
            return back();

        }
        session()->flash('error',trans('admin.invalid email'));
        return back();
    }
