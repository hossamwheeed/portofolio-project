      ...
      {{--<span class="badge bg-success">Online</span>--}}
        ...
        <ul class="navbar-nav">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-300">
                    ...
                    <div class="dropdown-content-body dropdown-scrollable">
                        <ul class="media-list">
                            <li class="media">
                                <div class="mr-3">
                                    <img src="{{url('/')}}/backend/global_assets/images/placeholders/placeholder.jpg"
            ...
            <ul class="navbar-nav">
                ...
                <!--        <img src="{{url('/')}}/backend/global_assets/images/lang/gb.png" class="img-flag mr-2" alt="">-->
                <!--        {{trans('admin.language')}}-->
                <!--    </a>-->

                <!--    <div class="dropdown-menu dropdown-menu-right">-->

                <!--        <a href="{{aurl('lang/ar')}}"><i class="dropdown-item english">عربي</i></a>-->
                <!--        <a href="{{aurl('lang/en')}}"><i class="dropdown-item english">English</i></a>-->
                <!--    {{-- <a href="" class="dropdown-item english"> English</a>-->
                <!--    <a href="#" class="dropdown-item ukrainian"> Українська</a> --}}-->
                ...
                <li class="nav-item dropdown dropdown-user">
                    <a href="#" class="navbar-nav-link dropdown-toggle" data-toggle="dropdown">
                        @if(empty(admin()->user()->photo_id))
                             <img src="{{url('/')}}/backend/global_assets/images/placeholders/placeholder.jpg" class="rounded-circle" alt="">
                           @else
                             <img src="{{ Storage::url(\App\Models\Images::find(admin()->user()->photo_id)->file) }}" width="38" height="38" class="rounded-circle" alt="">
                        @endif
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a href="{{aurl('logout')}}" class="dropdown-item"><i class="icon-switch2"></i> @lang('admin.logout')</a>
                    </div>
                </li>
            </ul>
            ...
            {{-- <li class="nav-item dropdown dropdown-user">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                ...
                <div class="dropdown-divider"></div>
                <a href="#" class="dropdown-item"><i class="icon-cog5"></i> Account settings</a>
                <a href="{{aurl('logout')}}" class="dropdown-item"><i class="icon-switch2"></i> Logout</a>
              </div>
            </li> --}}
        </ul>
    </div>
